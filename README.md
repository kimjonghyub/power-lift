<div style="font-family: 'Malgun Gothic', sans-serif; line-height: 1.6; font-size: 16px; color: #333;">
  <h2 style="color: #1d5fa8;">📡 파워 안테나 리프트</h2>
  <p><strong>– SUS304 본체 / 92.6Nm 고토크 대응 / 리니어 액추에이터 구동 –</strong></p>
  
  <img src="IMAGE01.jpg" alt="제품 전체 모습" style="width:100%; max-width:800px; margin: 20px 0; border:1px solid #ccc;" />

  <h3 style="color:#1d5fa8;">✅ 제품 개요</h3>
  <p>
    파워 안테나 리프트는 차량 루프에 장착하여 HF/VHF/UHF 안테나를 자동으로 전개·수납할 수 있는 고강도 전동 리프트입니다.
    SUS304 스테인리스 본체로 제작되어 내부식성과 내구성이 우수하며, 스크류 타입 리니어 액추에이터(별도구매)를 장착하여 구동합니다.
  </p>

  <img src="IMAGE020.jpg" alt="설치 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  <img src="IMAGE021.jpg" alt="설치 예시" style="width:100%; max-width:800px; margin: 20px 0;" />

  <h3 style="color:#1d5fa8;">🔧 주요 특징</h3>
  <ul>
    <li><strong>구동 방식:</strong> 스크류 타입 리니어 액추에이터 장착형 (※ 별도구매)</li>
    <li><strong>정격 토크 대응:</strong> 92.6Nm 이상</li>
  ...
  <img src="IMAGE031.jpg" alt="브라켓 클로즈업" style="width:100%; max-width:800px; margin: 10px 0;" />
  <li><strong>전용 브라켓 :</strong> 올뉴카니발, 더뉴카니발</li>
  <img src="IMAGE030.jpg" alt="브라켓 클로즈업" style="width:100%; max-width:800px; margin: 10px 0;" />
  ...
  <p>※ 그 외 차종(쏘렌토, 스타렉스 등)은 요청 시 맞춤 브라켓 제작 가능합니다.</p>

  <img src="IMAGE04.jpg" alt="카니발 장착 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  <img src="IMAGE041.jpg" alt="카니발 장착 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  ...
  <img src="IMAGE05.jpg" alt="설계 도면 이미지" style="width:100%; max-width:800px; margin: 20px 0;" />
  ...
  <img src="IMAGE06.jpg" alt="콜사인 플레이트 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  <li>기지국 안테나 브라켓 <strong>(별도 주문 사양)</strong></li>
  <img src="IMAGE07.jpg" alt="기지국 브라켓 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  <li>기지국 안테나 예시 <strong>(7.1m 수직형 안테나)</strong></li>
  <img src="IMAGE08.jpg" alt="기지국 안테나 예시" style="width:100%; max-width:800px; margin: 20px 0;" />
  <li>안테나 받침 브라켓 <strong>(알루미늄 및 3D 프린팅 파트)</strong></li>
  <img src="IMAGE09.jpg" alt="안테나 받침대 예시" style="width:100%; max-width:800px; margin: 20px 0;" />



  <h3 style="color:#1d5fa8;">📦 구성품</h3>
  <ul>
    <li>SUS304 본체 프레임 1세트</li>
    <li>전용 클램프 (카니발 3종 대응) - 옵션</li>
    <li>고정용 볼트·와셔 세트</li>
    <li>PDF 설치 가이드</li>
  </ul>
  ...
  <p>
    ...
    📱 카카오톡 채널: <strong>@HL5JYS</strong><br/>
    💬 전국 배송 
  </p>
</div>
